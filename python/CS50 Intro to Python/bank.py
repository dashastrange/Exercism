...
In a file called bank.py, implement a program that prompts the user for a greeting. If the greeting starts with “hello”, output $0. If the greeting starts with an “h” (but not “hello”),
...
if formatted_greeting.startswith("hello"):
    print("$0")
elif formatted_greeting.startswith("h") and formatted_greeting.startswith("hello") == False:
    print("$20")
else:
    print("$100")
